...
import simpletorch
from simpletorch import Context, ScalarFunction, ScalarHistory
...
def test_chain_rule1() -> None:
    x = simpletorch.Scalar(0.0)
    constant = simpletorch.Scalar(
...
def test_chain_rule2() -> None:
    var = simpletorch.Scalar(0.0, ScalarHistory())
    constant = simpletorch.Scalar(
...
def test_chain_rule4() -> None:
    var1 = simpletorch.Scalar(5)
    var2 = simpletorch.Scalar(10)
